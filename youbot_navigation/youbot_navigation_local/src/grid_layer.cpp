#include<simple_map/grid_layer.h>
...
namespace grid_layer
{
			       ...
			       double* min_y, double* max_x, double* max_y)
  {
    ...
    double mark_x = origin_x + cos(origin_yaw)+ g_count, mark_y = origin_y + sin(origin_yaw) + g_count;
    g_count++;
    unsigned int mx;
    unsigned int my;
	...
	for (int i = min_i; i < max_i; i++)
	  {
	    ...
	    std::cout << "GRID - COSTS: " << i << ", " << j << std::endl; 
	  }
      }
  }
